...
C:\Windows\system32\inetsrv\appcmd.exe set config -section:system.applicationHost/applicationPools /+"[name='$applicationPoolName'].environmentVariables.[name='COR_PROFILER_PATH_32',value='C:/AppDynamics/AppDynamics.Profiler_x86.dll']" /commit:apphost
C:\Windows\system32\inetsrv\appcmd.exe set config -section:system.applicationHost/applicationPools /+"[name='$applicationPoolName'].environmentVariables.[name='COR_PROFILER_PATH_64',value='C:/AppDynamics/AppDynamics.Profiler_x64.dll']" /commit:apphost
